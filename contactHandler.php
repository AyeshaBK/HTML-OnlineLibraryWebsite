...
<html lang='en-US'>
    ...
    <?php
        ...
        $connection = mysql_connect("localhost", "root", "")
            or die("Cannot connect to sever : ".mysql_error());
    
        $db = mysql_select_db("ouat", $connection)
            or die("ould not connect to database : ".mysql_error());

        $query = "INSERT INTO users(firstname, lastname, age, gender, email, comments) 
                    VALUES ('$user_fname', '$user_lname', '$user_age', '$user_gender', '$user_email', '$user_comments')";
